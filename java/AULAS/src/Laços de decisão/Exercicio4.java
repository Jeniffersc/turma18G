...
public class Exercicio4 {
	public static void main (String[] args)
	{
		...
		{
			raiz = Math.sqrt(n);
			System.out.println("O número " + n + " é par. Sua raiz quadrada de é: " + Math.round(raiz));
		}
		else
		{
			pot = Math.pow(n, 2);
			System.out.println("O número " + n + " é ímpar. E elevado ao quadrado é: " + Math.round(pot));
		}
	}
}